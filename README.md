...
1. Clone this repo - `git clone git@github.com:zach-adams/sprig-foundation.git` or [download the zip file](https://github.com/zach-adams/sprig/archive/master.zip) and install it like a normal WordPress theme.
